...
#ifndef ASYNCMESSAGEBOXFACTORY_H
#define ASYNCMESSAGEBOXFACTORY_H

#include <QMessageBox>

class AsyncMessageBoxFactory {
public:
...
private:
  static void show(QMessageBox::Icon icon, QWidget *parent,
                   const QString &title, const QString &text,
                   QMessageBox::StandardButtons buttons);
};

#endif // ASYNCMESSAGEBOXFACTORY_H
